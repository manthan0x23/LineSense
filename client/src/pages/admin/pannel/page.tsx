...
const PannelPage = () => {
    ...
    return (
        <div className="h-[100vh] w-[100wh] p-5">
            ...
            <div className="h-[90%] w-full  flex justify-start items-start gap-4">
                {data &&
                    data.map((metroL) => {
                        ...
                        }} className="w-[20rem] relative overflow-hidden cursor-pointer hover:scale-102 transition-all" key={metroL.id}>
                            <div className="absolute bottom-0 right h-1 w-full" style={{ backgroundColor: metroL.color }} />
                            <CardHeader>
