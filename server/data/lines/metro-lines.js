...
export const metroLines = [
  ...
  //   stations: [
  //     metroStationData.dwarka_Blue,
  //     metroStationData.dwarkaSector21_Blue,
  //     metroStationData.dwarkaSector14_Blue,
  //     metroStationData.dwarkaSector13_Blue,
  //     metroStationData.dwarkaSector12_Blue,
  //     metroStationData.dwarkaSector11_Blue,
  //     metroStationData.dwarkaSector10_Blue,
  //     metroStationData.dwarkaSector9_Blue,
  //     metroStationData.dwarkaSector8_Blue,
  //     metroStationData.dwarkaMor_Blue,
  //     metroStationData.nawada_Blue,
  //     metroStationData.uttamNagarWest_Blue,
  //     metroStationData.uttamNagarEast_Blue,
  //     metroStationData.janakpuriWest_Blue,
  //     metroStationData.janakpuriEast_Blue,
  //     metroStationData.tilakNagar_Blue,
  //     metroStationData.subhashNagar_Blue,
  //     metroStationData.tagoreGarden_Blue,
  //     metroStationData.rajouriGarden_Blue,
  //     metroStationData.rameshNagar_Blue,
  //     metroStationData.motiNagar_Blue,
  //     metroStationData.kirtiNagar_Blue,
  //     metroStationData.patelNagar_Blue,
  //     metroStationData.shadipur_Blue,
  //     metroStationData.rajendraPlace_Blue,
  //     metroStationData.karolBagh_Blue,
  //     metroStationData.jhandewalan_Blue,
  //     metroStationData.ramakrishnaAshramMarg_Blue,
  //     metroStationData.rajivChowk_Blue,
  //     metroStationData.barakhambaRoad_Blue,
  //     metroStationData.mandiHouse_Blue,
  //     metroStationData.supremeCourt_Blue,
  //     metroStationData.indraprastha_Blue,
  //     metroStationData.yamunaBank_Blue,
  //     metroStationData.laxmiNagar_Blue,
  //     metroStationData.mayurViharI_Blue,
  //     metroStationData.mayurViharExtension_Blue,
  //     metroStationData.kaushambi_Blue,
  //     metroStationData.vaishali_Blue,
  //   ],
  //   start: metroStationData.dwarka_Blue,
  //   end: metroStationData.vaishali_Blue,
  // },
  {
